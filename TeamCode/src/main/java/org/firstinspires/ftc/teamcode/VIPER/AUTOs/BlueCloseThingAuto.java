...
@Autonomous(name= "Blue Close Auto", group = "GEN4")
public class BlueCloseThingAuto extends LinearOpMode {
    ...
    private double GATE_HIT_X_POS = -57;
    private double SPIKE_X_POS = -48;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            alliance.set(alliance.Color.BLUE); // TODO: CHECK
        ...
        switch (state) {
            ...
            case GATE_INTAKES:
                ...
                if (splineCounter == 0) {
                    ...
                    robot.goToPoint(
                            new Pose2D(DistanceUnit.INCH, SPIKE_X_POS, -16, AngleUnit.DEGREES, 180),
                            1, 3, 0.8
                    );
                    ...
                    robot.goToPoint(
                            new Pose2D(DistanceUnit.INCH, -64, -16, AngleUnit.DEGREES, 180),
                            1, 3, 0.25
                    );
